...
import type { SliderStep, StepResult } from '../../domain'
import type { CompleteOptions } from '../types'
import { PLOT_AREA, PLOT_PADDING, PLOT_VIEW_BOX, clampToRange, lineEndpoints } from '../plotGeometry'
...
export function SliderStepView({
  ...
  const [lineStart, lineEnd] = lineEndpoints(slope, intercept, range)
