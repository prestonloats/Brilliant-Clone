...
//
// Every `id` matches an asset shipped at `public/scenery/<id>.png`, served at `/scenery/<id>.png`
...
// absolute path resolves in both `vite dev` and the Firebase Hosting deploy.
export const scenerySrc = (id: SceneId): string => `/scenery/${id}.png`
