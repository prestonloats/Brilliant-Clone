...
// AND a run of consecutive first-try corrects, so one lucky answer can never flip mastery.
export const PRACTICE_MASTERY_THRESHOLD = 0.85
export const PRACTICE_MASTERY_STREAK = 3
